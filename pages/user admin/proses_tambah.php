...
if (empty($ID) || empty($NAMA) || empty($EMAIL) || empty($TELEPON) || empty($PASSWORD1) || empty($PASSWORD2) ) { // jika dari pengecekan sebelumnya ada field yang kosong maka akan menampilkan pesan error
?>
...
<?php
    ...
    echo '<meta http-equiv="refresh" content="1; url=index.php?inc=user_admin">';
}
