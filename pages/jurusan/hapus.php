            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-auto">
                                <h4 class="header-title"> Hapus User Admin</h4>
                            </div>
                        </div>
                        <div class="tab-content">
                            ...
                            <div class="alert alert-dark  border-0 fade show" role="alert">
                                ...
                                <a href="?inc=user_admin&aksi=proses delete&id=<?php echo $ROW['id_user'] ?>"><button type="button" class="btn btn-danger" name="Hapus"><i class="ri ri-delete-bin-line"></i> Delete</button></a>
                                <a href="?inc=user_admin"><button type="button" class="btn btn-success" name="Cancel"><i class="ri  ri-arrow-go-back-line"></i> <span>Cancle</span> </button></a>
                            </div>
